...
local RetrofiyConfig = {
	...
	RetroCoreGui = false, -- [B] -- Replaces the Core Gui with a 2016 Core Gui (Playerlist, topbar, etc)
	RetroWorkspace = false, -- [R] -- Uses old materials, disables terrain decoration, only allows brick colors and returns 2016 studs
	RetroCharacters = false, -- [B] -- Displays health bars above the heads of characters & returns old oof sound
	RetroChat = false, -- [R] -- If default chat is enabled it will convert it to the 2016 chat
